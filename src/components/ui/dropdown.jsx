...
export default function Dropdown() {
  return (
    <div className=" flex items-center justify-center font-sans p-8">
      <DropdownMenu
        trigger={
          <div className="flex items-center justify-center w-10 h-10 rounded-full bg-white text-black border border-gray-300 hover:bg-gray-100 cursor-pointer">
            <img
