    ...
    const fetchPopularReviews = async () => {
      try {
        ...
        if (data && data.length > 0) {
          const userIds = [...new Set(data.map(r => r.user_id).filter(id => id))];
        ...
        <div className="flex animate-scroll-reviews gap-6">
          ...
          {reviews.map((review, index) => (
            ...
            >
              ...
              {/* Review Text */}
              <p className="text-gray-700 mb-4 line-clamp-4 min-h-[100px]">
                {review.review}
              </p>
              ...
              <div className="border-t border-gray-100 pt-4 mt-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-xs text-gray-500 line-clamp-1">{review.product_name}</p>
