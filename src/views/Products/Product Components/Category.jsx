    ...
    <div className="bg-white mb-6 z-40">
      ...
      <div className="relative px-12">
        ...
        >
          ...
          <CarouselPrevious className="bg-green-500 text-white hover:bg-green-600 border-green-500 -left-4" />
          <CarouselNext className="bg-green-500 text-white hover:bg-green-600 border-green-500 -right-4" />
        </Carousel>
      </div>
    </div>
  );
